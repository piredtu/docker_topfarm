...
# Running topfarm_hub
run_hub:
	docker run -d -p 8000:8000 -v /var/run/docker.sock:/docker.sock -v /etc/passwd:/srv/jupyterhub/userlist --env-file $(GITHUB_APP) --net=host --name $(HUB_NAME) piredtu/topfarm_hub
